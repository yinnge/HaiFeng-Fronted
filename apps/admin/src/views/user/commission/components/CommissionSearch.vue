...
import type { CommissionQueryDTO } from '@/types/user/commission'

const props = defineProps<{
  modelValue: CommissionQueryDTO
}>()

const emit = defineEmits<{
  (e: 'update:modelValue', val: CommissionQueryDTO): void
  (e: 'search'): void
  (e: 'reset'): void
}>()
  ...
  <div class="search-card">
    ...
    <el-form :model="queryParams" inline class="search-form">
      <el-form-item label="推荐人手机号">
        <el-input
          v-model="queryParams.referrerPhone"
          placeholder="前缀匹配"
          clearable
          style="width: 150px"
          @keyup="handleKeyup"
      ...
      <el-form-item label="推荐人名称">
        <el-input
          v-model="queryParams.referrerName"
          placeholder="模糊搜索"
          clearable
          style="width: 140px"
          @keyup="handleKeyup"
