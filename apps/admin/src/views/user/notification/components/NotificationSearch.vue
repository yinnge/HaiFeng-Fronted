...
import type { NotificationQueryDTO } from '@/types/user/notification'

const props = defineProps<{
  modelValue: NotificationQueryDTO
  notificationTypeLabel: Record<string, string>
}>()

const emit = defineEmits<{
  (e: 'update:modelValue', val: NotificationQueryDTO): void
  (e: 'search'): void
  (e: 'reset'): void
}>()
  ...
  <div class="search-card">
    ...
    <el-form :model="queryParams" inline class="search-form">
      ...
      <el-form-item label="通知类型">
        ...
        >
          <el-option
            v-for="(label, val) in notificationTypeLabel"
            :key="val"
            :label="label"
            :value="val"
          />
