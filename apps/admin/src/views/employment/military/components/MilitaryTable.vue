...
import type { MilitaryListVO } from '@/types/employment/military'
...
const emit = defineEmits<{
  (e: 'detail', row: MilitaryListVO): void
  (e: 'edit', row: MilitaryListVO): void
  ...
  (e: 'import'): void
  (e: 'refresh'): void
  (e: 'selection-change', rows: MilitaryListVO[]): void
...
<template>
  ...
  <div class="table-card">
    ...
    >
      ...
      <el-table-column prop="department" label="所属部门" min-width="150" show-overflow-tooltip />
      ...
      <el-table-column prop="regDeadline" label="报名截止" width="170" />
