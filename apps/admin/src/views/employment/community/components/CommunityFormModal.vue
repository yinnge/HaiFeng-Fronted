...
<template>
  <el-dialog class="community-form-dialog" :model-value="visible" title="修改社区工作者岗位" width="1000px" :close-on-click-modal="false" @update:model-value="emit('update:visible', $event)">
