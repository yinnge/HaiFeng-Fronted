  ...
  <div>
    ...
    <div class="custom-table">
      <el-table :data="data" v-loading="loading" stripe @selection-change="emit('selection-change', $event)">
        ...
        <el-table-column prop="supervisingDept" label="主管部门" min-width="140" show-overflow-tooltip />
        <el-table-column prop="positionType" label="岗位类型" min-width="120" show-overflow-tooltip />
...
.btn-tool { position: relative; z-index: 1; display: inline-flex; align-items: center; gap: 6px; border-radius: 20px; padding: 8px 20px; font-size: 13px; cursor: pointer; border: none; transition: all 0.2s; }
