...
import type { GrassrootsListVO } from '@/types/employment/grassroots'

const props = defineProps<{
  data: GrassrootsListVO[]
  loading: boolean
  total: number
  page: number
  size: number
...
const emit = defineEmits<{
  ...
  import: []
  refresh: []
  'selection-change': [rows: GrassrootsListVO[]]
  'page-change': [page: number]
  'size-change': [size: number]
}>()

const statusOptions = ['招募中', '已结束', '即将开始']
