...
const emit = defineEmits<{
  ...
  (e: 'update:institutionCategory', val: string): void
  (e: 'update:institutionType', val: string): void
    ...
    <div class="search-form">
      <el-form inline>
        ...
        <el-form-item label="机构大类">
          <el-select
            :model-value="institutionCategory"
            placeholder="全部"
            clearable
            style="width: 120px"
            @update:model-value="emit('update:institutionCategory', $event)"
          >
        ...
        <el-form-item label="机构类型">
          <el-input
            :model-value="institutionType"
            placeholder="机构类型"
            clearable
            style="width: 120px"
            @update:model-value="emit('update:institutionType', $event)"
            @keyup.enter="emit('search')"
          />
        </el-form-item>
