...
import type { CivilListVO } from '@/types/employment/civil'
...
const emit = defineEmits<{
  (e: 'detail', row: CivilListVO): void
  (e: 'edit', row: CivilListVO): void
  (e: 'delete', id: string): void
  (e: 'status-change', row: CivilListVO, val: string): void
  (e: 'batch-delete'): void
  (e: 'pre-validate'): void
  (e: 'import'): void
  (e: 'refresh'): void
  (e: 'selection-change', rows: CivilListVO[]): void
    ...
    >
      ...
      <el-table-column prop="regStatus" label="报名状态" width="100" align="center">
        <template #default="{ row }">
          <span :class="['pill', regStatusPill[row.regStatus] || 'pill-gray']">{{ row.regStatus }}</span>
        </template>
      </el-table-column>
