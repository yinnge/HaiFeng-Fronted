...
const emit = defineEmits<{
  ...
  (e: 'update:recruitingDept', val: string): void
  (e: 'update:workLocation', val: string): void
  (e: 'update:examType', val: string): void
  (e: 'update:regStatus', val: string): void
  (e: 'update:minEducation', val: string): void
  (e: 'search'): void
  (e: 'reset'): void
}>()
    ...
    <div class="search-form">
      <el-form inline>
        ...
        <el-form-item label="招录部门">
          <el-input
            :model-value="recruitingDept"
            placeholder="招录部门"
            clearable
            style="width: 160px"
            @update:model-value="emit('update:recruitingDept', $event)"
            @keyup.enter="emit('search')"
          />
        </el-form-item>
        ...
        <el-form-item label="工作地点">
          <el-input
            ...
            clearable
            style="width: 120px"
            @update:model-value="emit('update:workLocation', $event)"
            @keyup.enter="emit('search')"
          />
        </el-form-item>
        ...
        <el-form-item label="考试类型">
          <el-select
            ...
            clearable
            style="width: 110px"
            @update:model-value="emit('update:examType', $event)"
          >
        ...
        <el-form-item label="报名状态">
          <el-select
            :model-value="regStatus"
            placeholder="全部"
            clearable
            style="width: 110px"
            @update:model-value="emit('update:regStatus', $event)"
          >
        ...
        <el-form-item label="最低学历">
          <el-select
            :model-value="minEducation"
            placeholder="全部"
            clearable
            style="width: 110px"
            @update:model-value="emit('update:minEducation', $event)"
          >
