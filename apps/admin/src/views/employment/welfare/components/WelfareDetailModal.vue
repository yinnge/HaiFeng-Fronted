...
<template>
  <el-dialog class="welfare-dialog" :model-value="visible" title="公益性岗位详情" width="1000px" :close-on-click-modal="false" @update:model-value="emit('update:visible', $event)">
...
.welfare-dialog :deep(.el-dialog) { border-radius:12px; overflow:hidden; }
.welfare-dialog :deep(.el-dialog__header) { border-bottom:2px solid rgba(249,115,22,0.15); padding:20px 24px; margin:0; }
.welfare-dialog :deep(.el-dialog__title) { font-size:16px; font-weight:600; color:#1f2937; }
.welfare-dialog :deep(.el-dialog__body) { padding:24px; }
.welfare-dialog :deep(.el-dialog__footer) { border-top:1px solid #f3f4f6; padding:16px 24px; }
.welfare-dialog :deep(.el-input__wrapper), .welfare-dialog :deep(.el-textarea__inner), .welfare-dialog :deep(.el-select__wrapper) { border-radius:8px; transition:all .25s ease; }
.welfare-dialog :deep(.el-input__wrapper:hover), .welfare-dialog :deep(.el-textarea__inner:hover), .welfare-dialog :deep(.el-select__wrapper:hover) { box-shadow:0 0 0 1px rgba(249,115,22,0.3) inset; }
.welfare-dialog :deep(.el-input__wrapper.is-focus), .welfare-dialog :deep(.el-textarea__inner:focus), .welfare-dialog :deep(.el-select__wrapper.is-focused) { box-shadow:0 0 0 1px #F97316 inset; }
.welfare-dialog :deep(.el-descriptions__label) { font-weight: 600; color: #374151; background: rgba(249, 115, 22, 0.06) !important; }
.welfare-dialog :deep(.el-descriptions__content) { color: #1f2937; }
.welfare-dialog :deep(.el-descriptions__cell) { border-color: rgba(249, 115, 22, 0.1); }
.welfare-dialog :deep(.el-descriptions__body) { border-radius: 8px; overflow: hidden; }
