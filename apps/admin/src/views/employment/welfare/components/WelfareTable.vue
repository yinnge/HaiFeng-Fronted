...
.btn-tool { display: inline-flex; align-items: center; gap: 6px; border-radius: 20px; padding: 8px 20px; font-size: 13px; cursor: pointer; border: none; transition: all 0.2s; position: relative; z-index: 1; }
