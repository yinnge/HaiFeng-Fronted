...
import type { TeacherListVO } from '@/types/employment/teacher'
...
const emit = defineEmits<{
  ...
  (e: 'status-change', row: TeacherListVO, val: string): void
  (e: 'batch-delete'): void
  (e: 'import'): void
  (e: 'preview'): void
  (e: 'refresh'): void
  (e: 'selection-change', rows: TeacherListVO[]): void
...
<template>
  ...
  <div class="table-card">
    ...
    >
      ...
      <el-table-column prop="schoolName" label="学校名称" min-width="200" show-overflow-tooltip />

      <el-table-column prop="schoolType" label="学校类型" width="100" />

      <el-table-column prop="schoolNature" label="学校性质" width="80" />

      <el-table-column prop="positionName" label="岗位名称" min-width="160" show-overflow-tooltip />
