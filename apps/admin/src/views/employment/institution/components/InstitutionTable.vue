...
import type { InstitutionListVO } from '@/types/employment/institution'

const props = defineProps<{
  data: InstitutionListVO[]
  loading: boolean
  total: number
  page: number
  size: number
...
const emit = defineEmits<{
  (e: 'detail', row: InstitutionListVO): void
  (e: 'edit', row: InstitutionListVO): void
  (e: 'delete', id: string): void
  (e: 'status-change', row: InstitutionListVO, val: string): void
  (e: 'batch-delete'): void
  (e: 'pre-validate'): void
  (e: 'import'): void
  (e: 'refresh'): void
  (e: 'selection-change', rows: InstitutionListVO[]): void
...
<template>
  ...
  <div class="table-card">
    ...
    >
      ...
      <el-table-column prop="supervisingDept" label="主管单位" min-width="150" show-overflow-tooltip />
      ...
      <el-table-column prop="subCategory" label="职位分类" width="100" />

      <el-table-column prop="salaryRange" label="薪资范围" width="120" />

      <el-table-column prop="positionStatus" label="招聘状态" width="100" align="center">
