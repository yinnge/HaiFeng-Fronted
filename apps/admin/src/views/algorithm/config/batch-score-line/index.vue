...
<template>
  <div class="page-wrap">
    ...
    <div class="page-header">
      <div class="page-title">批次分数线管理</div>
      <div class="page-subtitle">管理各省份高考批次分数线与位次线数据</div>
    </div>
      ...
      <el-form :model="queryParams" inline class="search-form">
        <div class="filter-fields">
          ...
          <el-form-item label="批次">
            <el-input v-model="queryParams.batch" placeholder="全部" clearable style="width: 140px;" @keyup.enter="handleSearch" />
          </el-form-item>
    ...
    <div class="table-card">
      <div class="custom-table">
        <el-table :data="tableData" v-loading="loading" stripe @selection-change="handleSelectionChange">
          ...
          <el-table-column prop="scoreLine" label="分数线" min-width="100">
            <template #default="{ row }">
...
.batch-hard-delete-btn:hover:not(:disabled) {
  transform: translateY(-1px);
  box-shadow: 0 4px 12px rgba(185, 28, 28, 0.5);
}
.batch-hard-delete-btn:disabled {
  opacity: 0.45;
  cursor: not-allowed;
}
