...
import type { AnnouncementQueryDTO } from '@/types/home/announcement'

const emit = defineEmits<{
  (e: 'search', params: Pick<AnnouncementQueryDTO, 'title' | 'status'>): void
  (e: 'reset'): void
}>()
...
const handleSearch = () => {
  emit('search', { title: searchForm.title, status: searchForm.status })
}
