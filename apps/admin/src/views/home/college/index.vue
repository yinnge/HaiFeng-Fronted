...
import CollegeFormModal from './components/CollegeFormModal.vue'
import CollegeDetailModal from './components/CollegeDetailModal.vue'

/** 大学资源：固定面向人群 */
const AUDIENCE = 'college' as const
...
<template>
  <div class="college-page">
    ...
    <div class="page-header">
      <div class="page-title">大学资源</div>
      <div class="page-subtitle">管理大学学习资料文件，支持上传、下载、修改与删除</div>
    </div>
