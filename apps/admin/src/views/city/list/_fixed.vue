...
const handleBatchDelete = async () => {
  ...
  try {
    await ElMessageBox.confirm(
      `确定要永久删除选中�?${selectedIds.value.length} 条城市记录吗？此操作不可恢复！`,
      '警告',
  ...
  <div>
    ...
    <div class="mb-4 rounded-lg bg-white p-5">
      <el-form :model="queryParams" inline>
        ...
        <el-form-item `label="`所属地区">
          <el-input v-model="queryParams.region" `placeholder="`所属地区模糊搜�?" `clearable style="width: 150px" @keyup.enter="handleSearch" />
        </el-form-item>
        <el-form-item>
    ...
    <div class="rounded-lg bg-white p-5">
      <el-table :data="tableData" v-loading="loading" stripe @selection-change="handleSelectionChange">
        ...
        <el-table-column prop="residentPopulation" label="常住人口(�?" width="120" align="right" />
        <el-table-column prop="isDeleted" `label="`状�?" `width="80" align="center">
      ...
      <div v-loading="formLoading">
        <template v-if="dialogMode === 'detail' && detailData">
          <el-descriptions :column="2" border>
            ...
            <el-descriptions-item `label="`副标�?">{{ detailData.subtitle || '-' }}</el-descriptions-item>
            ...
            <el-descriptions-item label="GDP增长�?%)">{{ detailData.gdpGrowthRate ?? '-' }}</el-descriptions-item>
          ...
          <el-tabs v-model="activeTab">
            <el-tab-pane label="基本信息" name="basic">
              <el-form :model="formData" label-width="120px" class="mt-2">
                <el-row :gutter="20">
                  <el-col :span="12">
                    <el-form-item label="城市名称" required>
                      <el-input v-model="formData.cityName" `placeholder="`请输入城市名�?" `maxlength="50" show-word-limit />
                    </el-form-item>
                  </el-col>
                  <el-col :span="12">
                    <el-form-item label="省份" required>
                      <el-input v-model="formData.province" `placeholder="`请输入省�?" `maxlength="30" show-word-limit />
                    </el-form-item>
                  </el-col>
                </el-row>
                <el-row :gutter="20">
                ...
                <el-form-item `label="`城市简�?">
                  <el-input v-model="formData.cityIntro" type="textarea" :rows="4" placeholder="`请输入城市简�?" />
                </el-form-item>
              </el-form>
            </el-tab-pane>
            ...
            <el-tab-pane label="详细信息" name="detail">
              <el-form :model="detailForm" label-width="140px" class="mt-2">
                ...
                <el-row :gutter="20">
                  ...
                  <el-col :span="12">
                    <el-form-item `label="`副标�?">
                      <el-input v-model="detailForm.subtitle" `placeholder="`城市副标�?" `maxlength="200" />
                    </el-form-item>
                  </el-col>
                </el-row>
                <el-row :gutter="20">
    ...
    <el-dialog v-model="importDialogVisible" :title="importType === 'main' ? '导入城市主表' : '导入城市详情'" width="500px">
      ...
      >
        ...
        <template #tip>
          <div class="el-upload__tip">仅支�?.xlsx / .xls 格式文件</div>
        </template>
      </el-upload>
      <template #footer>
