    ...
    <div class="login-card relative w-[420px] rounded-2xl p-8">
      ...
      <div class="mb-8 pb-6 relative z-10 text-center">
        <div class="inline-flex items-center justify-center gap-2 mb-2">
          ...
          <h2 class="card-title text-xl font-bold">用户登录</h2>
        </div>
        <p class="mt-2 text-sm text-gray-400">欢迎回来，请登录您的账号</p>
      ...
      <div class="relative z-10">
        ...
        <div class="mt-3 text-center text-sm text-gray-500 relative z-10">
          还没有账号？
          <router-link to="/register" class="text-[#bf8a30] hover:text-[#a67c28] font-medium transition-colors">
            立即注册
          </router-link>
        </div>
      </div>
